let lang = {
    ...
    ar : {
        ...
        knowMore : "اعرف اكثر",
        wru : 'من نحن ؟',
        weare : 'نحن مجموعة من طلاب علوم الكمبيوتر في esi sba ، اخترنا التطبيق المحتاج كعنوان لمشروع 2cpi. أعضاء فريقنا هم: Ouared islem، Fellah Slimene، Mokhtari Meriem، Oueddan Youscef، Zenasni Yousef، Chaib fakhreddin.',
        whatis : 'التطبيق المحتاج هو تطبيق لمساعدة الأشخاص في العثور على احتياجاتهم من الأشياء إلى الخدمات التي يتم إثباتها من قبل مستخدمين آخرين.',
        ...
        card4t:'في كل مكان',
        card4p:'أينما كنت يمكنك استخدام المحتاجين ، فهو غير محدد لأي دولة أو منطقة.',
        mm:'و المزيد...',
        title4:'قدم رايك',
